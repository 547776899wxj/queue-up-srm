...
export default {
	...
	methods: {
		...
		init() {
			...
			let res = {data:{"Data":"<record><column  name=\"count_no\" value=\"17\"><dept><deptName>急诊科(病区)</deptName><bedNum>17</bedNum></dept></column><column  name=\"today_in\" value=\"\"><dept><deptName>急诊科(病区)</deptName><bedNum>3</bedNum></dept></column><column  name=\"mov_bed\" value=\"\"><dept><deptName></deptName><bedNum></bedNum></dept></column>Column 'rycwh0' does not belong to table Table.<column  name=\"count_critical\" value=\"\"><dept><deptName>急诊科(病区)</deptName><bedNum>8、4、1、6、2、5、3</bedNum></dept></column><column  name=\"count_in_out\" value=\"\"><dept><deptName>急诊科(病区)</deptName><bedNum>8、4、5、2、1</bedNum></dept></column><column  name=\"count_bedsore\" value=\"\"><dept><deptName>急诊科(病区)</deptName><bedNum>4</bedNum></dept></column><column  name=\"custody\" value=\"\"><dept><deptName>急诊科(病区)</deptName><bedNum>4、1、6、2、5、3</bedNum></dept></column><column  name=\"count_falling\" value=\"\"><dept><deptName></deptName><bedNum>6、7、10、19</bedNum></dept></column><column  name=\"remarks\" value=\"\"><dept><deptName></deptName><bedNum>总值班护士长：范国勤\n值班医生：王榕\n</bedNum></dept></column><column  name=\"division\" value=\"\"><dept><deptName></deptName><bedNum></bedNum></dept></column><column  name=\"chemotherapy\" value=\"\"></column><column  name=\"tomorrow_chemotherapy\" value=\"\"></column><column  name=\"pipeLine\" value=\"\"><dept><deptName>急诊科(病区)</deptName><bedNum>19、4、5、2、1</bedNum></dept></column></record>"}}
			setTimeout(()=>{
				this.init();
			},10000)
					...
					case 'count_no':
						...
						if(item.dept instanceof Array){
							item.dept.forEach((dept)=>{
								text += dept.deptName + dept.bedNum
								total += dept.bedNum
							})
						}else{
							text += item.dept.deptName + item.dept.bedNum
